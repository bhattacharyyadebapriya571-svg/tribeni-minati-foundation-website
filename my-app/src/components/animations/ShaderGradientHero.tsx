  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // Soft ripple near mouse cursor
        float ripple = smoothstep(0.4, 0.0, d) * 0.15;
    ...
    const resize = () => {
      ...
      canvas.width = width / 2; // low-res rendering for 60fps performance
    ...
    const render = (now: number) => {
      ...
      gl.uniform2f(uMouseLocation, mousePos.x / 2, mousePos.y / 2);
